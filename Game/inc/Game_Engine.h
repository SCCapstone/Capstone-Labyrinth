...
void Game_Engine::initWalls() {
    ...
    Wall* wall_R1 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(1.0f*scale, 18.0f*scale));
    Wall* wall_U1 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(1.0f*scale, 21.0f*scale));
    Wall* wall_W1 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(1.0f*scale, 23.0f*scale));
    Wall* wall_X2 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(2.0f*scale, 24.0f*scale));
    Wall* wall_S3 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(2.0f*scale, 19.0f*scale));
    Wall* wall_U4 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(4.0f*scale, 21.0f*scale));
    Wall* wall_X4 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(4.0f*scale, 24.0f*scale));
    Wall* wall_Y5 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(5.0f*scale, 25.0f*scale));
    Wall* wall_U6 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(6.0f*scale, 21.0f*scale));
    Wall* wall_T7 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(7.0f*scale, 20.0f*scale));
    Wall* wall_X7 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(7.0f*scale, 24.0f*scale));
    Wall* wall_Y8 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(8.0f*scale, 25.0f*scale));
    Wall* wall_V9 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(9.0f*scale, 22.0f*scale));
    Wall* wall_A10 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(10.0f*scale, 1.0f*scale));
    Wall* wall_S10 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(10.0f*scale, 19.0f*scale));
    Wall* wall_W10 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(10.0f*scale, 23.0f*scale));
    Wall* wall_Z10 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(10.0f*scale, 26.0f*scale));
    Wall* wall_B11 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(11.0f*scale, 2.0f*scale));
    Wall* wall_P11 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(11.0f*scale, 16.0f*scale));
    Wall* wall_V11 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(11.0f*scale, 22.0f*scale));
    Wall* wall_C12 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(12.0f*scale, 3.0f*scale));
    Wall* wall_T12 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(12.0f*scale, 20.0f*scale));
    Wall* wall_X12 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(12.0f*scale, 24.0f*scale));
    Wall* wall_Z12 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(12.0f*scale, 26.0f*scale));
    Wall* wall_B13 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(13.0f*scale, 2.0f*scale));
    Wall* wall_L13 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(13.0f*scale, 12.0f*scale));
    Wall* wall_Q13 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(13.0f*scale, 17.0f*scale));
    Wall* wall_U13 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(13.0f*scale, 21.0f*scale));
    Wall* wall_E14 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(14.0f*scale, 5.0f*scale));
    Wall* wall_H14 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(14.0f*scale, 8.0f*scale));
    Wall* wall_K14 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(14.0f*scale, 11.0f*scale));
    Wall* wall_N14 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(14.0f*scale, 14.0f*scale));
    Wall* wall_R14 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(14.0f*scale, 18.0f*scale));
    Wall* wall_V14 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(14.0f*scale, 22.0f*scale));
    Wall* wall_B15 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(15.0f*scale, 2.0f*scale));
    Wall* wall_D15 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(15.0f*scale, 4.0f*scale));
    Wall* wall_Q15 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(15.0f*scale, 17.0f*scale));
    Wall* wall_T15 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(15.0f*scale, 20.0f*scale));
    Wall* wall_E16 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(16.0f*scale, 5.0f*scale));
    Wall* wall_H16 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(16.0f*scale, 8.0f*scale));
    Wall* wall_K16 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(16.0f*scale, 11.0f*scale));
    Wall* wall_M16 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(16.0f*scale, 13.0f*scale));
    Wall* wall_I17 = new Wall(&brickwall, Vector2f(2.0f*scale, 1.0f*scale), Vector2f(17.0f*scale, 9.0f*scale));
